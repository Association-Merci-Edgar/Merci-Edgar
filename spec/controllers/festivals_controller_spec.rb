...
describe FestivalsController do
  ...
  let(:valid_attributes) { { "nb_edition" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved festival as @festival" do
        ...
        post :create, {:festival => { "nb_edition" => "invalid value" }}, valid_session
        assigns(:festival).should be_a_new(Festival)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested festival" do
        ...
        Festival.any_instance.should_receive(:update_attributes).with({ "nb_edition" => "1" })
        put :update, {:id => festival.to_param, :festival => { "nb_edition" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the festival as @festival" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Festival.any_instance.stub(:save).and_return(false)
        put :update, {:id => festival.to_param, :festival => { "nb_edition" => "invalid value" }}, valid_session
        assigns(:festival).should eq(festival)
      end
