...
class Scheduling < ActiveRecord::Base
  ...
  attr_accessible :name, :period, :remark, :contract_tags, :contract_list, :style_tags, :prospectings_attributes, :show_buyer_name, :show_host_name, :show_host_kind, :scheduler_name, :external_show_buyer
